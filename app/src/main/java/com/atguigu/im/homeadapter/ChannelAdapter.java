...
public class ChannelAdapter extends BaseAdapter {
    ...
    private final List<ChannelBean.ResultBean.ChannelInfoBean> datas;

    public ChannelAdapter(Context mcontext, List<ChannelBean.ResultBean.ChannelInfoBean> data) {
