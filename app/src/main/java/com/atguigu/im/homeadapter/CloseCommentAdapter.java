...
public class CloseCommentAdapter extends RecyclerView.Adapter{
    private final Context mcontext;
    private final List<ChannelBean.ResultBean.CLOSEBean.CommentBeanXX> data;

    private ViewHolder viewHolder;

    public CloseCommentAdapter(Context mcontext, List<ChannelBean.ResultBean.CLOSEBean.CommentBeanXX> commentBeanXes) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(List<ChannelBean.ResultBean.CLOSEBean.CommentBeanXX> data, int position) {
