...
public class Constant {
    ...
    public static final String GETONEINFO = "http://192.168.1.105:8080/IntelCd/getPic";

    public static final String GETKETUSER = "http://192.168.1.105:8080/IntelCd/getKeyByUser";
