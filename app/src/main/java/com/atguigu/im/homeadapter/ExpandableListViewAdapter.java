...
public class ExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    private ShopListActivity goodsListActivity;
    private int childP;
    private int groupP;



    public ExpandableListViewAdapter(ShopListActivity context, ArrayList<String> group, ArrayList<List<String>> child) {
        this.context = context;
        this.group = group;
        this.child = child;
        goodsListActivity = new ShopListActivity();
    }
