...
public class KtvCommentAdapter extends RecyclerView.Adapter{
    private final Context mcontext;
    private final List<ChannelBean.ResultBean.KTVBean.CommentBean> data;

    private ViewHolder viewHolder;

    public KtvCommentAdapter(Context mcontext, List<ChannelBean.ResultBean.KTVBean.CommentBean> commentBeanXes) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(List<ChannelBean.ResultBean.KTVBean.CommentBean> data, int position) {
